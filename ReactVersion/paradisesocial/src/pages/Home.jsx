...
const Home = () => {
  ...
  return (
    ...
    <div className='h-[400px] w-full flex items-center flex-col'>
      ...
      <div className='w-full max-w-[800px] h-fit m-28 rounded flex justify-center flex-row gap-5'>
        <h1 className='text-2xl md:text-4xl text-blue-600 font-bold bg-gradient-to-r from-blue-500 via-purple-500 to-pink-500 bg-clip-text text-transparent animate-gradient-slow infinite'>Color.</h1><p className='text-2xl md:text-4xl bg-gradient-to-r from-blue-500 to-pink-500 bg-clip-text text-transparent animate-pulse-slow pulse-slow infinite'> A platform like no other.</p>
      </div>
  ...
  (<Link to='/chat'><button className='bg-blue-600 w-44 h-11 rounded-lg cursor-pointer text-white text-xl hover:bg-purple-400'>Enter Color</button></Link>) 
